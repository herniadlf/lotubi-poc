...
import LotUbiArtifact from "../contracts/LotUbi.json";
...
export class Dapp extends React.Component {
  ...
  async _initializeEthers() {
    ...
    this._lotUbi = new ethers.Contract(
      contractAddress.LotUbi,
      LotUbiArtifact.abi,
  ...
  _startPollingData() {
    this._pollDataInterval = setInterval(() => this._refreshLotUbiBalance(), 1000);
  ...
  async _pickANumber(numberBet) {
    ...
    try {
      ...
      await this._refreshLotUbiBalance();
    } catch (error) {
